...
% - bag of words vs. sequence models vs. sentence-level embeddings
% - accounting for use of context and grammar to convey meaning
% - pre-training vs. customized training vs. training-free

% Neural Probabilistilc Language Model (NPLM): BengEtal03 --> explicitly model word sequences
% Scalable Hierarchical Distributed Language Model (SHDLM): MnihHint09 --> sequences of word trees

%word2vec: MikoEtal13 --> semantic relations reflected in geometric operations
%GloVe: PennEtal14 --> combines matrix factorization and local context window methods
%SkipThought: KiroEtal15 --> reconstructs surrounding sentences of an encoded passage
%BERT: DevlEtal18 --> pretraining language representations, context dependence of word embeddings
%ELMO: PeteEtal18 --> how is it different from BERT/GPT?
%InferSent: ConnEtal18 --> embeddings of sentences
%Universal Sentence Encoder: CerEtal18 --> embeddings of sentences
%Open-GPT: RadfEtal18 --> pretrained transformer (how is it different from BERT?)
%RandSent: WietKiel19 --> training-free sentence-level embeddings
%GPT-2: RadfEtal19
%GPT-3: BrowEtal20
